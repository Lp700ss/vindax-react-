...
const Deposit = () => {
  ...
  const onTabContainer1Click = useCallback(() => {
    // Please sync "Withdraw" to the project
  }, []);
  ...
  return (
    <div className={styles.depositDiv}>
      ...
      <div className={styles.inPillsWithBrandColorDesk}>
        ...
        <div className={styles.tabDiv1} onClick={onTabContainer1Click}>
          <div className={styles.textDiv}>Withdraw</div>
        </div>
          ...
          <div className={styles.frameDiv4}>
            ...
            <div className={styles.frameDiv6}>
              <img
                ...
                alt=""
                src="../bloggingsvgrepocom-113.svg"
              />
            ...
            <div className={styles.frameDiv8}>
              <img
                className={styles.flatColorIconsonlineSuppor}
                alt=""
                src="../goalsuccesssvgrepocom-113.svg"
              />
          ...
          <div className={styles.frameDiv10}>
            <div className={styles.columnDiv}>
              <div className={styles.tablesCellDiv}>
                <div className={styles.textDiv8}>Date</div>
              </div>
            ...
            <div className={styles.columnDiv1}>
              <div className={styles.tablesCellDiv15}>
                <div className={styles.textDiv8}>ID</div>
              </div>
              <div className={styles.divider} />
              <div className={styles.tablesCellDiv1}>
            ...
            <div className={styles.columnDiv2}>
              <div className={styles.tablesCellDiv15}>
                <div className={styles.textDiv8}>Amount</div>
              </div>
              <div className={styles.divider} />
              <div className={styles.tablesCellDiv1}>
            ...
            <div className={styles.columnDiv3}>
              <div className={styles.tablesCellDiv}>
                <div className={styles.textDiv8}>ASSET</div>
              </div>
              <div className={styles.divider} />
              <div className={styles.tablesCellDiv1}>
            ...
            <div className={styles.columnDiv4}>
              <div className={styles.tablesCellDiv}>
                <div className={styles.textDiv8}>TXID</div>
              </div>
              <div className={styles.divider} />
              <div className={styles.tablesCellDiv1}>
            ...
            <div className={styles.columnDiv5}>
              <div className={styles.tablesCellDiv75}>
                <div className={styles.textDiv8}>Status</div>
              </div>
              <div className={styles.divider} />
              <div className={styles.tablesCellDiv76}>
                <div className={styles.badgeDiv}>
                  <div className={styles.textDiv84}>Pending</div>
                  <img
              ...
              <div className={styles.tablesCellDiv77}>
                <div className={styles.badgeDiv1}>
                  <div className={styles.textDiv84}>Expired</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv1}>
                <div className={styles.badgeDiv2}>
                  <div className={styles.textDiv84}>Succeed</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv2}>
                <div className={styles.badgeDiv2}>
              ...
              <div className={styles.tablesCellDiv80}>
                <div className={styles.badgeDiv1}>
                  <div className={styles.textDiv84}>Failed</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv2}>
                <div className={styles.badgeDiv2}>
        ...
        <div className={styles.cardFooterWithPageButtons}>
          ...
          <div className={styles.contentDiv}>
            <div className={styles.detailsDiv}>
              ...
              <span>{` of `}</span>
              <span className={styles.span}>97</span>
              <span> results</span>
            </div>
          ...
          <div className={styles.groupDiv14}>
            ...
            <div className={styles.groupDiv19}>
              <div className={styles.aPITheVinDAXCryptoTrading}>
                ...
                <p className={styles.careersP}>
                  <span className={styles.span}> or MacOS device.</span>
                </p>
              </div>
