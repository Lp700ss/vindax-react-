          ...
          <div className={styles.frameDiv2}>
            ...
            <div className={styles.frameDiv6}>
              <img
                className={styles.flatColorIconsonlineSuppor}
                alt=""
                src="../goalsuccesssvgrepocom-15.svg"
              />
      ...
      <div className={styles.groupDiv20}>
        <div className={styles.groupDiv21}>
          <div className={styles.groupDiv22}>
            ...
            />
            <TextField
              className={styles.groupTextField1}
              sx={{ width: 300 }}
              color="primary"
              variant="outlined"
              type="text"
...
"
          ...
          <TextField
            className={styles.groupTextField2}
            sx={{ width: 624 }}
            color="primary"
            variant="outlined"
            type="text"
...
"
          ...
          <div className={styles.groupDiv23}>
            ...
            <TextField
              className={styles.groupTextField3}
              sx={{ width: 300 }}
              color="primary"
              variant="outlined"
...
"
          ...
          <div className={styles.groupDiv28}>
            ...
            <div className={styles.groupDiv27}>
              <TextField
                ...
                margin="none"
              />
              <div className={styles.zIPCodeDiv}>ZIP code*</div>
            </div>
          </div>
          <TextField
            className={styles.groupTextField4}
            sx={{ width: 624 }}
            color="primary"
            variant="outlined"
            type="text"
        ...
        <div className={styles.frameDiv7}>
          <div className={styles.helloCryptoExchanger}>{`Create account `}</div>
        </div>
      </div>
      <Button
