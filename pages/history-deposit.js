...
import styles from "./history-deposit.module.css";

const HistoryDeposit = () => {
  const router = useRouter();

  const onTabContainerClick = useCallback(() => {
    router.push("/histor-withdraw");
  }, [router]);
  ...
  return (
    <div className={styles.historyDeposit}>
...
`}</p>
          ...
          <div className={styles.frameDiv3}>
            ...
            <div className={styles.frameDiv7}>
              <img
                className={styles.flatColorIconsonlineSuppor}
                alt=""
                src="../goalsuccesssvgrepocom-12.svg"
              />
            ...
            <div className={styles.columnDiv5}>
              ...
              <div className={styles.tablesCellDiv76}>
                <div className={styles.badgeDiv}>
                  <div className={styles.textDiv83}>Pending</div>
                  <img
              ...
              <div className={styles.tablesCellDiv77}>
                <div className={styles.badgeDiv1}>
                  <div className={styles.textDiv83}>Expired</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv1}>
                <div className={styles.badgeDiv2}>
                  <div className={styles.textDiv83}>Succeed</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv2}>
                <div className={styles.badgeDiv2}>
              ...
              <div className={styles.tablesCellDiv80}>
                <div className={styles.badgeDiv1}>
                  <div className={styles.textDiv83}>Failed</div>
                </div>
              </div>
              <div className={styles.tablesCellDiv2}>
                <div className={styles.badgeDiv2}>
      ...
      <div className={styles.component2Div}>
        ...
        <div className={styles.frameDiv14}>
          <img className={styles.groupIcon} alt="" src="../group-129042.svg" />
        </div>
